...
if (isset($_POST["login"])) {
  ...
  if ($select_admin->num_rows > 0) {
    ...
    $login_notification = "akun admin tidak di temukan";
  }
}
?>
...
<head>
  ...
  <title>KANGRESTO</title>
</head>

<body>
  <div class="super-center">
    <h1>KANGRESTO LOGIN</h1>
    <i>Pastikan tidak membagikan password, OTP atau kode akses kepada siapapun.</i>
